...
from auto_mi.utils import TarModelWriter, DirModelWriter
...
if __name__ == '__main__':
    ...
    if args.pretrain:
        ...
        train_optimiser_model(optimiser_model, interpretability_models, interpretability_model_io, subject_model_io, SUBJECT_MODEL, TASK, EPISODES, STEPS, subject_models_per_step=SUBJECT_MODELS_PER_STEP)
