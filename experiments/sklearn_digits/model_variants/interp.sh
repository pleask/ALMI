...
NUM_DIGITS=$NUM_DIGITS stdbuf -oL /home3/wclv88/bounding-mi/bin/python /home3/wclv88/bounding-mi-repo/experiments/sklearn_digits/benchmark.py --seed 0 --device cuda --subject_model_path sklearn_digits/variant_data/subject-models --interpretability_model_path=sklearn_digits/variant_data/interpretability_models --interpretability_model_batch_size 8 --subject_model_num_classes 10 --interpretability_model_split_on_variants