...
if __name__ == '__main__':
    ...
    if args.train_subject_models:
        ...
        interpretability_model = Transformer(subject_model_parameter_count, task.mi_output_shape, num_layers=2, num_heads=2, positional_encoding_size=8192).to(args.device)
